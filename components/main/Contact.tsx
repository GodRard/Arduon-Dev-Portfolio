...
function Contact() {
  return (
    <section
      id="contact"
      className="h-[45rem] w-full rounded-lg bg-[#131827] grid grid-cols-2 relative antialiased z-20"
    >
      <div className="max-w-2xl mx-auto p-4 justify-top items-center mt-8">
        <h2 className="font-bold text-lg md:text-4xl bg-clip-text text-center text-transparent bg-gradient-to-b from-blue-600 to-cyan-300">
          CONTACT ME
        </h2>
      ...
      <div className="max-w-2xl mx-auto p-4 z-30 mt-8">
